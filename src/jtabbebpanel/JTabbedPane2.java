...
public class JTabbedPane2 implements ActionListener, ChangeListener {
	...
	/*
	 * 实现ChangeListener方法，目的在使若左边的标签有点选过，右边的标签才会显示Enable状态。getSelectedIndex()
	 * 方法可返回
	 * 目前点选标签的index值，getTabCount()方法可返回JTabbedPane上目前共有几个标签，而setEnabledAt()
	 * 方法则是使某个标签 的状态为Enable或Disable(true为Enable,false为Disable).
	 */
	...
	/*
	 * 实现ActionListener接口,当用户按下"新增标签"按钮时，就 会在tabbedPane上新增一个Disable状态的标签。
	 */
